...
def getColumn():
    columns = {}
    url = 'http://172.28.3.157:8080/xchzxt/cenrep/queryByIdGridPanel.action?id=1200'
...
def getData():
    ...
    start = 0
    limit = 1000
    url = 'http://172.28.3.157:8080/xchzxt/team/queryByCondFormORGAN.action'
