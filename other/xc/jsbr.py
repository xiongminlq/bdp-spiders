...
def getColumn():
    columns = {}
    url = 'http://172.28.3.157:8080/xchzxt/cenrep/queryByIdGridPanel.action?id=1300'
...
def getData():
    ...
    start = 0
    limit = 6000
    url = 'http://172.28.3.157:8080/xchzxt/Dp/queryByCondFormwjwInfo.action'
            ...
            for i in range(1, pageCount + 1):
                ...
                if len(infos) > 0:
                    for info in infos:
                        ...
                        index += 1
                        addCellValue(sheet, index, values)
    newBook.save('data\精神病人-计生委.xls')
